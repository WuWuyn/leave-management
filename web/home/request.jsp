                ...
                <c:if test="${!(sessionScope.user.emp.staffs eq null)}">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="link_name">Process Reques</span>
                        </a>
                        <ul class="sub-menu blank">
                            <li><a class="link_name">Process Reques</a></li>
                        </ul>
                    </li>
                </c:if>
                    ...
                    <tbody>
                        <c:forEach items="${sessionScope.requests}" var="r" varStatus="status">
                            <tr>
                                ...
                                <td>${r.createdDate}</td>
                                <td>
                                    <c:if test="!${r.approvalDate eq null}">${r.approvalDate}</c:if>
                                    </td>
                                    <td><a href="modify?id=${r.id}">Modify</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
